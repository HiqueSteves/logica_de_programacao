...
select * from filmes where genero = 'Mistério e Suspense' or genero = 'Ficção e Fantasia';
...
update filmes set preco = 3.50 where id_filme = 71;
...
-- Qual é o erro? __________________________________________________________
-- o certo é região, estado seria 'Rio de Janeiro', 'Minas Gerais', etc
-- Correção:
...
-- Qual é o erro? __________________________________________________________
-- o certo é 'is' ao invez de = e sem ''
-- Correção:
...
-- Qual é o erro? __________________________________________________________
-- não existe a tabela actor, somente atores 
-- Correção:
...
-- Qual é o erro? __________________________________________________________
-- se fosse executado, o comando deixaria todos os filmes com o genero 'Fantasia', por n ter filtrado o id
-- Correção
-- select * from filmes where titulo = 'Harry Potter';
select * from filmes where titulo like 'Harry Potter%';
UPDATE filmes SET genero = 'Fantasia' where titulo like 'Harry Potter%'; -- teria q botar o id do filme, mas existem varios HP
